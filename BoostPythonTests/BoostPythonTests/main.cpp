...
int main()
{
	...
	py::object tf_ = py::import("tensorflow");

	np::ndarray d1 = np::array(py::make_tuple(1.0f, 2.0f, 3.0f, 4.0f));
	np::ndarray d2 = np::array(py::make_tuple(5.0f, 6.0f, 7.0f, 9.0f));

	py::object x1 = tf_.attr("constant")(d1);
	py::object x2 = tf_.attr("constant")(d2);

	py::object result = tf_.attr("multiply")(x1, x2);
